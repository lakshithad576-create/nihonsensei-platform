      ...
      >
        ...
        <form className="space-y-6" onSubmit={handleSignup}>
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className={`w-full py-4 mt-6 text-white rounded-2xl font-semibold text-lg transition-colors shadow-lg ${isLoading ? 'bg-zinc-400 cursor-not-allowed shadow-none' : 'bg-[#de1d4d] hover:bg-[#be1640] shadow-rose-500/25'}`}
          >
