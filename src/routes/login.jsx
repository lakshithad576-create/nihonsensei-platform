...
const petalPositions = [
  { top: '15%', left: '20%', size: 24, delay: 0,   dur: 7,  color: 'text-sakura-300', rot: 15  },
  { top: '25%', left: '70%', size: 18, delay: 1.2, dur: 9,  color: 'text-sakura-400', rot: -20 },
  { top: '45%', left: '40%', size: 22, delay: 0.6, dur: 8,  color: 'text-sakura-300', rot: 30  },
  { top: '65%', left: '80%', size: 28, delay: 2.1, dur: 11, color: 'text-sakura-400', rot: -10 },
  { top: '80%', left: '30%', size: 20, delay: 0.9, dur: 7,  color: 'text-sakura-300', rot: 45  },
];
...
export default function Login() {
  ...
  // <-- Added function to handle login submission
  const handleLogin = (e) => {
    e.preventDefault();
  ...
  return (
    <div className="min-h-screen flex font-sans bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12"
           style={{ background: 'linear-gradient(145deg, #fff0f3 0%, #ffe4ea 100%)' }}>
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          {petalPositions.map((p, i) => (
            <motion.div
              ...
              animate={{ y: [0, -20, -10, 0], rotate: [p.rot, p.rot + 15, p.rot - 5, p.rot], opacity: [0.6, 0.9, 0.7, 0.6] }}
        ...
        <div className="absolute bottom-10 right-10 opacity-40 pointer-events-none text-sakura-300 z-0">
          <svg width="240" height="200" viewBox="0 0 240 200" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Logo Top Left */}
        <Link to="/" className="relative z-10 flex items-center gap-2 text-xl font-bold text-zinc-900 tracking-tight" style={{ fontFamily: '"Comic Sans MS", "Comic Sans", cursive' }}>
        ...
        <div className="relative z-10 max-w-md pb-10">
          ...
          <motion.h1 
            ...
            className="text-4xl font-bold text-zinc-900 mb-3" style={{ fontFamily: '"Playfair Display", Georgia, serif' }}
          >
            Welcome back
          </motion.h1>
          <motion.p 
          ...
          >
            Log in to your account to continue learning Japanese with NihonSensei.lk
          </motion.p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white relative">
        ...
        <div className="absolute top-6 left-6 lg:hidden">
          <Link to="/" className="flex items-center gap-2 text-xl font-bold text-zinc-900 tracking-tight" style={{ fontFamily: '"Comic Sans MS", "Comic Sans", cursive' }}>
            <div className="w-8 h-8 rounded-full bg-[#ffe4ea] flex items-center justify-center shadow-sm">
              <Flower2 size={18} strokeWidth={2.5} color="#ff059f" />
            </div>
            <span>NihonSensei<span style={{ color: '#ff059f' }}>.lk</span></span>
        ...
        >
          {/* Card Header */}
          <h2 className="text-3xl font-bold text-zinc-900 mb-2 tracking-tight" style={{ fontFamily: '"Playfair Display", Georgia, serif' }}>
            Email login
          </h2>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <Mail className="absolute left-4 text-zinc-400" size={18} strokeWidth={2} />
                <input 
                  type="email" 
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <Lock className="absolute left-4 text-zinc-400" size={18} strokeWidth={2} />
                <input 
            ...
            <div className="flex justify-end pt-1">
              <a href="#" className="text-[#ff059f] text-xs font-bold hover:underline">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-center text-sm text-zinc-500 mt-8">
            Don't have an account? <Link to="/signup" className="text-[#ff059f] font-bold hover:underline">Sign up</Link>
          </p>
